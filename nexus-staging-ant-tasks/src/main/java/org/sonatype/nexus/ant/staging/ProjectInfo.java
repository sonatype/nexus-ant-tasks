 ...
 * are the "targeted" modes of Nexus Staging V2. In general, you don't use those two fields (you might set the
 * profileId
...
public class ProjectInfo
{
   ...
   * repository mode). In this mode, {@link StageRemotelyTask} will NOT close the staging repository (the one
   * creating
   * it should close it).
   */
