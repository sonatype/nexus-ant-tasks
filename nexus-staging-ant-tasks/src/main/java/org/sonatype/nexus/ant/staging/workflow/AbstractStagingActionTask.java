 ...
 * from locally staged repository to get the repository ID if not configured directly. This way, you can integrate
 * these
    ...
    if (stagingRepositoryId != null) {
      ...
      if (stagingRepositoryPropertiesFile.isFile()) {
        ...
        try {
          ...
          result = new String[]{stagingRepositoryProperties.getProperty(AbstractDeployTask.STAGING_REPOSITORY_ID)};
        }
        catch (IOException e) {
